  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full h-3 mt-2 bg-gray-50 rounded-lg">
        <div
          className="bg-blue-600 text-2xl h-full font-medium text-blue-100 text-center p-0.5 leading-none rounded-full "
          style={{ width: `${formData.reach}%` }}
        ></div>
      </div>
